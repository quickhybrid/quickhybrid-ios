...
@protocol QHJSExtendMethodDelegate <NSObject>

- (void)registExtendMethodForJSBridge:(WebViewJavascriptBridge *)bridge
                       withController:(QHBaseWebLoader *)baseWebLoader;

@end

@interface WebViewJavascriptBridge : WVJB_WEBVIEW_DELEGATE_INTERFACE

@property (nonatomic, weak) id<QHJSExtendMethodDelegate> extendDelegate;
