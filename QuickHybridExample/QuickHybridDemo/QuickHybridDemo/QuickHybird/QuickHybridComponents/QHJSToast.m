...
+ (instancetype)toastMessage:(NSString *)message duration:(NSTimeInterval)duration {
    ...
    CGSize toastSize = [message boundingRectWithSize:CGSizeMake(contextView.frame.size.width - 20 * 2, MAXFLOAT) options:NSStringDrawingUsesLineFragmentOrigin attributes:@{NSFontAttributeName:titleFont} context:nil].size;
    ...
    QHJSToast *toast = [[QHJSToast alloc] initWithFrame:contextView.frame];
